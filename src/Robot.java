...
public class Robot implements Runnable
{
    ...
    protected void driveManual(float x, float y, float angle,float force) throws InterruptedException{
    ...
    //QRCode
    public void recalibrage(float valueX) throws InterruptedException{
		if(valueX < 180){
